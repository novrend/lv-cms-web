        ...
        <section>
            ...
            <nav className="border-b border-gray-200">
                <div className="py-3 px-4 mx-auto max-w-screen-xl md:px-6">
                    <ul className="flex flex-wrap justify-center mt-0 mr-6 space-x-8 text-lg font-medium">
                        <li>
                            <a href="#" className="text-gray-900 hover:underline" aria-current="page">Home</a>
                        </li>
                        <li>
                            <a href="#" className="text-gray-900 hover:underline">New</a>
                        </li>
                        <li>
                            <a href="#" className="text-gray-900 hover:underline">Men</a>
                        </li>
                        <li>
