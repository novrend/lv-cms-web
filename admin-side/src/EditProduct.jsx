                    ...
                    <div className="p-6 space-y-6">
                        <form action="#">
                            <div className="grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <div className="relative">
                                        <div
                                            className="text-gray-500 dark:text-gray-400 flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                                            $
                                        </div>
                                ...
                                <div className="col-span-full">
                                    ...
                                    <textarea id="product-details" rows="4"
                                        className="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div className="flex items-center justify-center w-full">
                                <label
                                    className="flex flex-col w-full h-32 border-2 border-gray-300 border-dashed rounded cursor-pointer hover:bg-gray-50 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-700">
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p className="py-1 text-sm text-gray-600 dark:text-gray-500">Upload a file
                                            or drag and drop</p>
                                        <p className="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, GIF up to
                                            10MB</p>
                                    </div>
